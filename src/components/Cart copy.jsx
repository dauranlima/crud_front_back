    ...
    <div id="container">
      <div>
        ...
        {!totalCartItemsCount ? (
                      ...
                      <p className="font-bold text-[#87635A]">Your added items will appear here</p>
                  </div>
        ):(
        <div>
      ...
      <div id="valor total da cesta">
        <p>Total do Pedido</p>
        <p>R$ {totalOrderPrice.toFixed(2)}</p>
      </div>
      <div>
        <img src="/neutral.png" alt="carbonoImg" loading="lazy" />
        <p>Este é um produto com entrega <span>Carbono Free</span></p>
      </div>
    </div>
    </>
  )
